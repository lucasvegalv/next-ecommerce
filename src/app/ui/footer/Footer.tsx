      ...
      <div className='w-full p-10'>
        ...
        <div className='flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start md:gap-20'>
          ...
          <div className='flex flex-col items-center md:items-start mb-10 md:mb-0'>
            <Logo logoSize={40} logoColor='white' textColor='text-white' display='flex justify-center md:justify-start gap-2 items-center'/>
            <p className='text-gray-400 font-extralight text-center text-xs md:text-left mt-5'>
              We are a residential <span className='text-white font-light'>interior design firm</span> located in Portland. Our boutique-studio offers more than
            </p>
          </div>
          ...
          <ul className='text-gray-400 font-extralight text-center text-xs md:text-left'>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Assistance to the buyer</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Find an order</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Terms of delivery</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Exchange and return of goods</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Guarantee</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Frequently asked questions</li>
            </Link>
            <Link href='/'>
              <li className='py-2 hover:text-white hover:font-light'>Terms of use of the site</li>
            </Link>
          </ul>
        </div>
